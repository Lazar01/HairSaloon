...
function ContactPage(){
    return(
        <>
        <section className="ml-auto mr-auto bg-black">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-8">
                    ...
                    <Button type="submit" variant="outlined" color="deep-purple" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300">Send message</Button>
                </form>
            </div>
        </section>
        <Footer/>
