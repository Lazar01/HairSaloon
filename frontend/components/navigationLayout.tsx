...
function NavigationLayout() {
  ...
  return (
    ...
    <nav className="bg-black bg-opacity-75 bg-blend-overlay flex justify-between bg-center" style={{ backgroundImage: `url(${headerBackground})` }}>
      <Link to="/home" className="mt-auto mb-auto pl-12 flex md:h-24 sm:h-12 items-center justify-center text-white font-extrabold leading-none tracking-tight  md:text-2xl drop-shadow-[0_1.6px_1.6px_rgba(0,0,0,1)] basis-2/12">
